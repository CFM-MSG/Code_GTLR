...
def get_evaluator(dt="didemo"):
    if dt in ["anet", "charades", "tacos", "youcookii"]:
...
class TALLEvaluator(object):
    def __init__(self):
        ...
        # self.metrics = ["R5-0.1", "R5-0.3", "R5-0.5", "R5-0.7", "mIoU"]

        # self.metrics = ["R1-0.1", "R1-0.3", "R1-0.5", "R1-0.7", "R5-0.1", "R5-0.3", "R5-0.5", "R5-0.7"]
        self.duration = None
    ...
    def eval(self, preds, gts, rand_show = False):
